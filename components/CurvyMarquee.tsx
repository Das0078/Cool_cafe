...
export default function CurvyMarquee() {
  return (
    <div className="absolute bottom-[-22vh] left-1/2 z-40 hidden h-[40vh] w-[180vw] -translate-x-1/2 justify-center overflow-hidden rounded-[50%] bg-[#110a06] pt-8 shadow-[0_-20px_50px_rgba(0,0,0,0.4)] md:flex md:w-[130vw] md:pt-12">
